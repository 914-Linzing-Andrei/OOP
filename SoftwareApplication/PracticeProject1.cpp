...
PracticeProject1::PracticeProject1(Service& service, QWidget* parent)
    : QMainWindow(parent), service{ service }
{
    ui.setupUi(this);
}

PracticeProject1::~PracticeProject1()
{}

void PracticeProject1::addIssue() {
...
int PracticeProject1::getSelectedIndexFromAppsList()
{
...
void PracticeProject1::resolveIssue()
{
...
void PracticeProject1::removeIssue()
{
    string text = this->ui.appslistWidget->currentItem()->text().toStdString();
